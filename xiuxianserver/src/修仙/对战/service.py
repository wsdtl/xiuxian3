...
from ..common import CoreService, business_day, dump_json, load_json, money, random, split_words, to_int, ts
    ...
    def _format_robbery_loots(loots: list[dict]) -> str:
        ...
        for loot in loots:
            if loot.get("kind") == "weapon":
                weapon_id = f"#{loot['weapon_id']} " if loot.get("weapon_id") else ""
